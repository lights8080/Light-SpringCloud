/*
 * Copyright 2020 Light-SpringCloud.
 *
...
public class PropertiesFactory {
    ...
    private static final String DEFAULT_CLENT_NAME = "default";
    ...
    public boolean isSet(Class clazz, String name) {
        return StringUtils.hasText(getClassName(clazz, name)) || StringUtils.hasText(getClassName(clazz, DEFAULT_CLENT_NAME));
    }
    ...
    public <C> C get(Class<C> clazz, IClientConfig config, String name) {
        ...
        if (!StringUtils.hasText(className)) {
            className = getClassName(clazz, DEFAULT_CLENT_NAME);
        }
        if (StringUtils.hasText(className)) {
            try {
